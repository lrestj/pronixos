...
PS1='\[\033[1;34m\][\[\033[1;33m\]\u\[\033[1;00m\]@\[\033[1;34m\]\h \[\033[1;00;m\]\w\[\033[1;34;m\]]\[\033[32m\]\$ '
...
alias cleanall='sudo nix-collect-garbage -d && nix-collect-garbage -d && sudo nixos-rebuild boot'
alias reb='reboot'
alias nxs='nix-shell -p'
alias nrs='sudo nixos-rebuild switch --flake ~/.dotfiles/nixos/'
alias nco='vim ~/.dotfiles/configuration.nix'
alias npk='vim ~/.dotfiles/modules/pkgs.nix'
alias nnn='nnn -dH'
